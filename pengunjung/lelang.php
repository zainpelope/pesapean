...
$queryDataSapi = mysqli_query($koneksi, "
    ...
    WHERE l.status != 'Pending' AND l.status != 'Ditolak' " . // <--- Tambahkan kondisi ini untuk mengecualikan status 'Pending' dan 'Ditolak'
                    ...
                    <div class="card card-sapi">
                        ...
                        <div class="card-body">
                            ...
                            <?php elseif ($sapi['status'] == 'Lewat') : ?>
                                ...
                                <?php endif; ?>
                            <?php endif; ?>
                            <a href="../pengunjung/detail.php?id=<?= htmlspecialchars($sapi['id_sapi']); ?>&id_lelang=<?= htmlspecialchars($sapi['id_lelang']); ?>" class="btn btn-success w-100 mt-2">Detail Lelang</a>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
