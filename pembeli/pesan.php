...
if (!isset($_SESSION['id_user']) || $_SESSION['nama_role'] !== 'Pembeli') {
    header("Location: ../auth/login.php?error=Akses tidak diizinkan. Anda harus login sebagai Pembeli.");
    exit();
}

$current_user_id = $_SESSION['id_user']; // ID pembeli yang sedang login
...
<head>
    ...
    <title>Pesapean - Pesan Anda</title>
    ...
    <header class="main-header">
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="../pembeli/pesan.php" class="active">Pesan</a></li>
            </ul>
